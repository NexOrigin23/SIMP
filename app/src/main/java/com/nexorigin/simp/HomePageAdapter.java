...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case HomePageModel.HORIZONTAL_PRODUCT_VIEW:
                View horizontalProductView = LayoutInflater.from(parent.getContext()).inflate(R.layout.horitontal_scroll_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        switch (homePageModelList.get(position).getType()) {
            ...
            case HomePageModel.HORIZONTAL_PRODUCT_VIEW:
                ...
                List<WishlistModel> viewAllProductList = homePageModelList.get(position).getViewAllProductsList();
                ((HorizontalProductViewHolder) holder).setHorizontalProductLayout(horizontalProductScrollModelList, title, backgroundColor, viewAllProductList);
                break;
            case HomePageModel.GRID_PRODUCT_VIEW:
                String gridLayoutBackground = homePageModelList.get(position).getBackgroundColor();
                String gridLayoutTitle = homePageModelList.get(position).getTitle();
                List<HorizontalProductScrollModel> gridProductScrollModelList = homePageModelList.get(position).getHorizontalProductScrollModelList();
                ((GridProductViewHolder) holder).setGridProductLayout(gridProductScrollModelList, gridLayoutTitle, gridLayoutBackground);
                break;
            default:
                return;
        }
    ...
    public class BannerSliderViewHolder extends RecyclerView.ViewHolder {
        ...
        public BannerSliderViewHolder(@NonNull View itemView) {
            ...
            bannerSliderViewPager = itemView.findViewById(R.id.banner_slider_viewer);
        }
    ...
    public class HorizontalProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public HorizontalProductViewHolder(@NonNull View itemView) {
            ...
            horizontalLayoutRecyclerView.setRecycledViewPool(recyclerViewPool);
        }

        private void setHorizontalProductLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList, String title, String color, List<WishlistModel> viewAlProductList) {
            ...
            if (horizontalProductScrollModelList.size() > 8) {
                ...
                horizontalLayoutViewAllBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ViewAllActivity.wishlistModelList = viewAlProductList;
            ...
            LinearLayoutManager horizontalProductLinearLayoutManager = new LinearLayoutManager(itemView.getContext());
            horizontalProductLinearLayoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
            horizontalLayoutRecyclerView.setLayoutManager(horizontalProductLinearLayoutManager);
    ...
    public class GridProductViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setGridProductLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList, String title, String color) {
            ...
            for (int x = 0; x < 4; x++) {
                ...
                Glide.with(itemView.getContext()).load(horizontalProductScrollModelList.get(x).getProductImage()).apply(new RequestOptions().placeholder(R.drawable.category_placeholder)).into(productImage);
